# WitSensor Sample Code Provided by WitMotion
# This code is used to read the data from the WitMotion IMU sensor
# coding:UTF-8
import serial
...
if __name__=='__main__': 
    ...
    # port = raw_input('COM15');
    #port = input('please input port No. such as com7:'));
    baud = int(115200)
    ser = serial.Serial('COM15', baud, timeout=0.5)  # ser = serial.Serial('com7',115200, timeout=0.5) 
    print(ser.is_open)
    while(1):
        datahex = ser.read(33)
        a,w = DueData(datahex)
